...
public class ReflectionUtil {
    ...
    public static final Map<Class, Class> WRAPPERS = Collections.unmodifiableMap(new HashMap<Class, Class>(){{
    ...
    @SuppressWarnings("unchecked")
    private static Object getInstanceByFactoryMethod(Class valueClass, Object value, String methodName) {
