...
@Service
public class ExcelServiceImpl implements ExportService {
     ...
     */
    private <T> int prepareContent(Row row, CellStyle style, int index, List<ExportDefiner> definers, T entity) throws NoSuchFieldException, IllegalAccessException {
        for (ExportDefiner definer : definers) {
            if (entity == null) {
